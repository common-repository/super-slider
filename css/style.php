...
.textsuper {
	position: absolute;
		color: #fff;
	 background-image:url(\'http://localhost/word/wp-content/plugins/super-pro/images/textbg.png\');
...
position: relative;
	margin: 0px;
	padding:0px;
	 background-image:url(\''.$site_url.'/wp-content/plugins/super-pro/images/shadow.png\');
	list-style: none;
